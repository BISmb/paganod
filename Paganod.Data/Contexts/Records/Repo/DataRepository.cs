...
{
    private readonly Func<DbConnection> _GetNewDbConnection;
    ...
    public DataRepository(ISchemaReader schemaReader, Func<DbConnection> prmGetNewDbConnection)
    {
        _SchemaReader = schemaReader;
        _GetNewDbConnection = prmGetNewDbConnection;
